...
<body>
    ...
    <div class="container-fluid bg-dark fixed-bottom bg-dark">
        <div class="row">
            <div class="col-12 d-flex justify-content-center">
                <form action="">
                    <button type="button" class="mx-1 btn btn-light">News</button>
                    <button type="submit" class="btn btn-outline-secondary">Goods</button>
                </form>
            </div>
        </div>
    </div>
